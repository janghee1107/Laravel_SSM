...
<br>
			...
			<script>
				...
				function select_product()
				{
					...
					else
					{
						...
						form1.prices31.value = Number(form1.price31.value) * Number(form1.numo31.value);
					}
				}
			...
			<table class="table  table-bordered  table-sm  table-hover mymargin5">
					...
					<td width="80%" align="left">
						<div class ="d-inline-flex">
							<div class="input-group input-group-sm date" id="writeday31">
								<input type="text" name="writeday31" size="10" value="{{ $row->writeday31 }}"
						...
						</div> @error('writeday31') {{ $message }} @enderror
					</td>
				</tr>
				<tr>
					<td width="20%" class="mycolor2">
					...
					<td width="80%" align="left">
						<div class="d-inline-flex">
						<input type="hidden" name="products_id31" value="{{ $row->products_id31 }}">
						<input type="text" name="product_name31" value="{{ $row->product_name31 }}"
				...
				<tr>
					...
					<td width="80%" align="left">
						<div class="d-inline-flex">
							<input type="text" name="price31" size="20" value="{{ $row->price31 }}" 
				...
				<tr>
					...
					<td width="80%" align="left">
						<div class="d-inline-flex">
							<input type="text" name="numo31" size="20" value="{{ $row->numo31 }}"
							class="form-control form-control-sm" onchange="cal_prices31();">
						</div>
					</td>
				</tr>
				<tr>
					<td width="20%" class="mycolor2"> 금액
					</td>
					<td width="80%" align="left">
						<div class="d-inline-flex">
							<input type="text" name="prices31" size="20" value="{{ $row->prices31 }}"
							class="form-control form-control-sm" readonly>
						</div> 
					</td>
				</tr>
				<tr>
					<td width="20%" class="mycolor2"> 비고
					</td>
					<td width="80%" align="left">
						<div class="d-inline-flex">
							<input type="text" name="bigo31" size="20" value="{{ $row->bigo31 }}" 
							class="form-control form-control-sm">
						</div> 
					</td>
				</tr>
