		...
		<br>	
			...
			<script>
				...
				$(document).on("click",".ajax_edit",function() {
					...
					$("#data_name").val( $(this).data('name31'));
				});
			...
			@csrf
				<div class="row">
					...
					<div class="col-9" align="right">   
						 ...
						 <a href="#" class="ajax_add btn btn-sm mycolor1"
			...
			<table class="table  table-bordered  table-sm  table-hover mymargin5" id="table_list">
				<tr class="mycolor2">
					...
					<tr id="rowno{{$row->id}}">
						<td>{{ $row->id }}</td>
						<td>
							<a href='#ajaxModal' data-bs-toggle='modal' data-bs-target='#ajaxModal' class='ajax_edit' data-id="{{$row->id}}" data-name="{{$row->name31}}">{{$row->name31}}</a>
						</td>	
						<td>
							<a href="#ajaxModal" rowno="{{$row->id}}"  class="ajax_del btn btn-sm mycolor1">삭제</a>
						</td>	
					</tr>
					@endforeach
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-body bg-light">
			   ...
			   <div class="modal-footer alter-secondary">
