...
class JangbuoController extends Controller
{
    ...
    public function index()
    {
		...
		return view( 'jangbuo.index', $data );	// 자료 표시(view/jangbuo폴더의 index.blade.php)
    }
	...
	public function save_row(Request $request, $row)
	{
		...
		$row->numi31 		= 0;
		$row->numo31 		= $request->input("numo31");
    ...
    public function edit($id)
    {
		...
		$data['tmp'] = $this->qstring();
        $data['row'] = Jangbu::leftjoin('products', 'jangbus.products_id31', '=', 'products.id')->
			select('jangbus.*', 'products.name31 as product_name31')->
